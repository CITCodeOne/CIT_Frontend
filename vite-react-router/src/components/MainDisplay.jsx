 ...
 * @param {boolean} disableLink - If true, don't wrap in Link (for detail pages)
 */
function MainDisplay({
    ...
    if (disableLink) {
        // On detail pages (Title/Individual) we don’t wrap in <Link>,
        // so clicks on the bookmark button won’t navigate away.
        return content;
    }

    // Default behaviour: whole card clickable (used in lists/overview pages)
    return (
